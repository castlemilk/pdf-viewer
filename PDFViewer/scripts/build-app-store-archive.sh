...
APP_STORE_CODE_SIGN_IDENTITY="${MAC_APP_STORE_CODE_SIGN_IDENTITY:-3rd Party Mac Developer Application}"
APP_STORE_PROFILE_SPECIFIER="${MAC_APP_STORE_PROFILE_SPECIFIER:-Acacia Mac App Store}"
...
if [[ "$SKIP_ARCHIVE" != "1" ]]; then
  ARCHIVE_ARGS=(
    ...
    "MAC_APP_STORE_CODE_SIGN_IDENTITY=$APP_STORE_CODE_SIGN_IDENTITY"
    "MAC_APP_STORE_PROFILE_SPECIFIER=$APP_STORE_PROFILE_SPECIFIER"
