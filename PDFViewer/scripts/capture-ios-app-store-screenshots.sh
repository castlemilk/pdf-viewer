...
IPHONE_DEVICE="${IOS_SCREENSHOT_IPHONE_DEVICE:-iPhone 14 Plus}"
IPAD_DEVICE="${IOS_SCREENSHOT_IPAD_DEVICE:-iPad Pro 13-inch (M4)}"
IPHONE_RUNTIME="${IOS_SCREENSHOT_IPHONE_RUNTIME:-iOS 17.0}"
...
capture_set "$IPHONE_DEVICE" "$IPHONE_RUNTIME" "$OUT_ROOT/iphone-67"
capture_set "$IPAD_DEVICE" "$IPAD_RUNTIME" "$OUT_ROOT/ipad-129"

sips -g pixelWidth -g pixelHeight "$OUT_ROOT"/iphone-67/*.png "$OUT_ROOT"/ipad-129/*.png
