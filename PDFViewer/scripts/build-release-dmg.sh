...
APP_NAME="PDFViewer"
BUNDLE_ID="${BUNDLE_ID:-com.benebsworth.pdfviewer}"
...
DERIVED_DATA_PATH="${DERIVED_DATA_PATH:-$(mktemp -d /tmp/PDFViewerReleaseDerivedData.XXXXXX)}"
...
echo "=== PDFViewer macOS release builder ==="
